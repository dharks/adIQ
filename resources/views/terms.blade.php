...
<div class="legal-wrap">
    ...
    <p>These Terms of Service ("Terms") govern your access to and use of adIQ by Percivo, including the adIQ WordPress plugin, the web platform at <a href="{{ route('home') }}">adiq.percivo.io</a>, and related services (collectively, the "Service"), provided by Percivo ("we", "us", or "our").</p>
