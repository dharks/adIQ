...
<div class="card">
    ...
    <div class="email-chip">
        ...
        Authenticated as <?php echo e($email); ?>
    ...
    <?php if(empty($networks)): ?>
        ...
        <a href="<?php echo e($redirectUri); ?>" class="btn btn-outline">
    ...
    <?php else: ?>
                ...
                <select name="network_id" id="network_id">
                    <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $network): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($network['networkCode'] ?? ''); ?>"
                            ...
                            <?php echo e($network['displayName'] ?? $network['networkCode'] ?? 'Unknown Network'); ?>
        ...
        <hr class="divider">
        <a href="<?php echo e($redirectUri); ?>" class="btn btn-outline" style="font-size:13.5px;">
...
<?php /**PATH /Users/dharks/Documents/web-projects/adiq-site/resources/views/oauth/select-network.blade.php ENDPATH**/ ?>