...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — adIQ by Percivo</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('dashboard')); ?>"
               class="nav-link <?php echo e(request()->routeIs('dashboard') || request()->routeIs('sites.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.index')); ?>"
               class="nav-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">
                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="sidebar-footer">
            <div class="sidebar-user">
                ...
                <div class="user-info">
                    ...
                    <div class="user-role"><?php echo e(Auth::user()->is_admin ? 'Admin' : 'Publisher'); ?></div>
                </div>
            </div>
    ...
    <div class="page-wrap">
        ...
        <main class="page-content">
            <?php if(session('flash') || session('success')): ?>
                <div class="alert alert-success">
                    ...
                    <?php echo e(session('flash') ?? session('success')); ?>
...
<?php /**PATH /Users/dharks/Documents/web-projects/adiq-site/resources/views/layouts/app.blade.php ENDPATH**/ ?>