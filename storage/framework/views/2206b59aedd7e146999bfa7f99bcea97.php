<?php $__env->startSection('title', 'Privacy Policy — adIQ by Percivo'); ?>
<?php $__env->startSection('meta-description', 'Privacy Policy for adIQ by Percivo. Understand how we collect, use, and protect your data.'); ?>
...
<div class="legal-wrap">
    ...
    <p>This Privacy Policy describes how Percivo ("we", "us", or "our") collects, uses, and protects information when you use adIQ by Percivo, including the adIQ WordPress plugin, the adIQ web platform at <a href="<?php echo e(route('home')); ?>">adiq.percivo.io</a>, and any related services (collectively, the "Service").</p>
...
<?php echo $__env->make('layouts.marketing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dharks/Documents/web-projects/adiq-site/resources/views/privacy.blade.php ENDPATH**/ ?>