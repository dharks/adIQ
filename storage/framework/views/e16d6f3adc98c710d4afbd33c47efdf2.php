<?php $__env->startSection('title', 'adIQ by Percivo — Ad Infrastructure for WordPress Publishers'); ?>
<?php $__env->startSection('meta-description', 'Deploy and control any ad, across any network, from one place. Google Ad Manager, AdSense, and third-party networks unified under a single platform built for serious publishers.'); ?>
...
.section-heading.light-text { color: #fff; }
.section-heading.dark-text { color: var(--g900); }
.section-sub {
    font-size: 16px;
    line-height: 1.7;
    max-width: 560px;
}
.section-sub.light-text { color: rgba(255,255,255,0.5); }
.section-sub.dark-text { color: var(--g500); }
...
.network-card:hover { border-color: rgba(45,189,181,0.35); }
.network-icon {
...
.network-icon.gam  { background: rgba(66,133,244,0.15); }
.network-icon.adsense { background: rgba(52,168,83,0.15); }
.network-icon.third { background: rgba(45,189,181,0.12); }
.network-card h3 {
    font-size: 16px;
    font-weight: 700;
    color: #fff;
...
.au-left { display: flex; align-items: center; gap: 10px; }
.au-name { color: rgba(255,255,255,0.75); font-weight: 500; }
.au-network {
    font-size: 10.5px;
    padding: 2px 7px;
    border-radius: 4px;
...
.au-network.gam  { background: rgba(66,133,244,0.15); color: #4285f4; }
.au-network.adsense { background: rgba(52,168,83,0.15); color: #34a853; }
.au-network.third { background: rgba(45,189,181,0.12); color: var(--teal); }
.au-status {
...
.perf-cell:hover { background: rgba(255,255,255,0.05); }
.perf-num {
    font-size: 36px;
    font-weight: 900;
    color: var(--teal);
...
@media (max-width: 900px) {
    .networks-grid, .features-grid { grid-template-columns: 1fr 1fr; }
    .perf-grid { grid-template-columns: 1fr 1fr; }
    .control-grid { grid-template-columns: 1fr; gap: 40px; }
    .control-visual { display: none; }
}
@media (max-width: 640px) {
    .networks-grid, .features-grid, .perf-grid { grid-template-columns: 1fr; }
        ...
        <div class="networks-grid">
            <div class="network-card">
                <div class="network-icon gam">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="#4285f4"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/></svg>
                </div>
            ...
            <div class="network-card">
                <div class="network-icon adsense">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="#34a853"><path d="M21.35 11.1h-9.17v2.73h6.51c-.33 3.81-3.5 5.44-6.5 5.44C8.36 19.27 5 16.25 5 12c0-4.1 3.2-7.27 7.2-7.27 3.09 0 4.9 1.97 4.9 1.97L19 4.72S16.56 2 12.1 2C6.42 2 2.03 6.8 2.03 12c0 5.05 4.13 10 10.22 10 5.35 0 9.25-3.67 9.25-9.09 0-1.15-.15-1.81-.15-1.81z"/></svg>
                </div>
            ...
            <div class="network-card">
                <div class="network-icon third">
                    <svg width="22" height="22" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
                </div>
            ...
            <div>
                ...
                <div class="control-points">
                    <div class="control-point">
                        <div class="cp-icon">
                            <svg width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18"/></svg>
                        </div>
                        <div class="cp-text">
                    ...
                    <div class="control-point">
                        <div class="cp-icon">
                            <svg width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"/></svg>
                        </div>
                        <div class="cp-text">
                    ...
                    <div class="control-point">
                        <div class="cp-icon">
                            <svg width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                        </div>
                        <div class="cp-text">
                    ...
                    <div class="control-point">
                        <div class="cp-icon">
                            <svg width="16" height="16" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                        </div>
                        <div class="cp-text">
    ...
    <div class="container">
        ...
        <div class="features-grid">
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><rect x="5" y="2" width="14" height="20" rx="2"/><path d="M12 18h.01"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 102.13-9.36L1 10"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h6M9 12h6M9 15h4"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M17 8l-5-5-5 5M12 3v12"/></svg>
                </div>
            ...
            <div class="feature-card">
                <div class="feat-icon">
                    <svg width="18" height="18" fill="none" stroke="var(--teal)" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 010 14.14M4.93 4.93a10 10 0 000 14.14"/></svg>
                </div>
...
<div class="percivo-band">
    <img src="<?php echo e(asset('images/percivo-black-bg.png')); ?>" alt="Percivo" style="height:28px;width:auto;opacity:0.7;">
...
<section class="cta-section">
    <div style="position:relative;z-index:1;">
        ...
        <div class="cta-actions">
            ...
            <a href="https://percivo.com/adIQ" target="_blank" rel="noopener" class="btn-hero-ghost">
                Learn more at percivo.com
            </a>
        </div>
    </div>
</section>
