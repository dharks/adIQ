<?php $__env->startSection('title', 'adIQ by Percivo — Publisher Ad Management for WordPress'); ?>
...
<section class="hero">
    <div class="hero-inner">
        ...
        <div class="hero-actions">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn-hero-secondary">Sign In</a>
            <?php endif; ?>
        </div>
...
<section class="cta-section">
    <div class="cta-inner">
        ...
        <div class="cta-actions">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn-cta-secondary">Already have an account? Sign in →</a>
            <?php endif; ?>
        </div>
    </div>
</section>
